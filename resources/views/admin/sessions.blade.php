...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="flex items-center justify-between mb-6">
        ...
        <button class="bg-indigo-600 text-white px-4 py-2 rounded-lg font-medium">Tambah Sesi</button>
    </div>
    <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-6 text-slate-600">
        Sesi latihan dibuat dari jadwal untuk tanggal dan jam tertentu.
    </div>
</div>
@endsection
